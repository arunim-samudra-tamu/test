function createTanPlane(options) {
  ...
  Figure.camera = options.camera;
    Figure.camera.position.z = 2.5*(Math.max(Figure.xrange,Figure.yrange,Figure.zrange));
  Figure.cameracontrols = new THREE.OrbitControls(Figure.camera, Figure.renderer.domElement);
  ...
  Figure.surfacegeometry = new THREE.ParametricGeometry(surfacefunction, 25, 25);
  ...
  if (options.cbyline != null) {
    Figure.genyTrace = function(color) {
      ...
      for (var i = Figure.xmin; i <= Figure.xmax; i += 0.1) {
  ...
  if (options.cbyplane != null) {
    ...
    Figure.ysquaregeom = new THREE.BoxGeometry(0.01,Figure.yrange,Figure.zrange);
    var ysquaremat = new THREE.MeshBasicMaterial({color: 0x00ff00, opacity: 0.15, transparent: true});
  ...
  if (options.cbxplane != null) {
    ...
    Figure.xsquaregeom = new THREE.BoxGeometry(Figure.xrange,0.01,Figure.zrange);
    var xsquaremat = new THREE.MeshBasicMaterial({color: 0xff00ff, opacity :0.15, transparent: true});
  ...
  if (options.cbytline != null) {
    Figure.genyTan = function(color) {
      ...
      Figure.ytanline = PlotPoints2D({
        ...
        xmin: -(Figure.xrange) / 5,
        xmax: (Figure.xrange) / 5,
        ymin: -(Figure.yrange) / 5,
        ymax: (Figure.yrange) / 5,
        step: 1,
        colorline: color
      });
    }
  ...
  if (options.cbtplane != null) {
    ...
    Figure.tsquaregeom = new THREE.BoxGeometry(2*(Figure.xrange)/5, 2*(Figure.yrange)/5, 0.2);
    var tsquaremat = new THREE.MeshBasicMaterial({color:0x000000, opacity: 0.15, transparent: true});
  ...
  Figure.scene.add(Figure.everything);
    ...
    Figure.everything.position.y = Figure.zrange / 2;
  ...
  if (options.xyrenderer != null) {
    ...
    Figure.ystate = 1;
  	...
  	Figure.dragControls = new THREE.DragControls( [Figure.xypt], Figure.xycamera, Figure.xyrenderer.domElement );
      Figure.dragControls.addEventListener( 'dragstart', function( event) {
        ...
        Figure.tx = Math.asin(Figure.xval/10);
        Figure.ty = Math.asin(Figure.yval/10);
  ...
  Figure.updatextan = function() {
    Figure.tx -= 0.001;
    var oldx = 10 * Math.sin(Figure.tx);
  ...
  Figure.updateytan = function() {
    Figure.ty -= 0.001;
    var oldy = 10 * Math.sin(Figure.ty);
  ...
  Figure.updatetplane = function() {
    ...
    Figure.tanplane.rotation.x = Figure.yangle;
    Figure.tanplane.rotation.y = -Figure.xangle;
    return;
  }
  ...
  if (options.cbxplay != null) {
    ...
    Figure.cbxplay.change( function() {
      ...
      if (Figure.boolyplay) {
        document
          .getElementById("ex-1e")
          .setAttribute("src", "../../../graphics/check.jpg");
      } else {
        document
          .getElementById("ex-1e")
          .setAttribute("src", "../../../graphics/bullet5.jpg");
      }
    });
  }
  ...
  if (options.cbxplane != null) {
    ...
    Figure.cbxplane.change( function() {
      ...
      if (Figure.boolxplane && exercise_1_step_1_2) {
        document
          .getElementById("ex-1a")
          .setAttribute("src", "../../../graphics/check.jpg");
      } else if (Figure.boolxplane) {
        exercise_1_step_1_1 = true;
      } else {
        document
          .getElementById("ex-1a")
          .setAttribute("src", "../../../graphics/bullet1.jpg");
        exercise_1_step_1_1 = false;
  }
    });
  }
  if (options.cbyline != null) {
    ...
    Figure.cbyline.change( function() {
      ...
      if (Figure.boolyline) Figure.everything.add(Figure.yline);
      else Figure.everything.remove(Figure.yline);
    })
  }
  if (options.cbxline != null) {
    ...
    Figure.cbxline.change( function() {
      ...
      if (Figure.boolxline) {
        ...
        document
          .getElementById("ex-1b")
          .setAttribute("src", "../../../graphics/check.jpg");
      } else {
        Figure.everything.remove(Figure.xline);
        document
          .getElementById("ex-1b")
          .setAttribute("src", "../../../graphics/bullet2.jpg");
  }
    });
  }
  if (options.cbytline != null) {
  ...
  if (options.cbxtline != null) {
    ...
    Figure.cbxtline.change( function() {
      ...
      if (Figure.boolxtline) {
        Figure.everything.add(Figure.xtanline);
        document
          .getElementById("ex-1d")
          .setAttribute("src", "../../../graphics/check.jpg");
      } else {
        Figure.everything.remove(Figure.xtanline);
        document
          .getElementById("ex-1d")
          .setAttribute("src", "../../../graphics/bullet4.jpg");
  }
    });
  }
  if (options.xslider != null) {
    ...
    Figure.xslider.on('input', function() {
      ...
      if (Figure.xval === 6.0) {
        console.log("slider value is 6");
        document
          .getElementById("ex-1c")
          .setAttribute("src", "../../../graphics/check.jpg");
      } else {
        console.log("slider value is not 6");
        document
          .getElementById("ex-1c")
          .setAttribute("src", "../../../graphics/bullet3.jpg");
      }
      Figure.tx = Math.asin(Figure.xval / 10);
  ...
  if (options.yslider != null) {
    ...
    Figure.yslider.on('input', function() {
      ...
      if (Figure.yval === 5.0 && exercise_1_step_1_1) {
        document
          .getElementById("ex-1a")
          .setAttribute("src", "../../../graphics/check.jpg");
      } else if (Figure.yval === 5.0) {
        exercise_1_step_1_2 = true;
      } else {
        document
          .getElementById("ex-1a")
          .setAttribute("src", "../../../graphics/bullet1.jpg");
        exercise_1_step_1_2 = false;
      }
      Figure.ty = Math.asin(Figure.yval / 10);
  ...
  if (options.colXZ != null) {
    ...
    $(Figure.colXZ).on('input', function() {
      ...
      Figure.xsquare = null;
      var xsquaremat = new THREE.MeshBasicMaterial({color: color, opacity: 0.15, transparent: true});
      Figure.xsquare = new THREE.Mesh(Figure.xsquaregeom, xsquaremat);
  ...
  if (options.colYZ != null) {
    ...
    $(Figure.colYZ).on('input', function() {
      ...
      var ysquaremat = new THREE.MeshBasicMaterial({color: color, opacity: 0.15, transparent: true});
      Figure.ysquare = new THREE.Mesh(Figure.ysquaregeom, ysquaremat);
  ...
  if (options.coltPlane != null) {
    ...
    $(Figure.coltPlane).on('input', function() {
      ...
      var tsquaremat = new THREE.MeshBasicMaterial({color:color, opacity: 0.15, transparent: true});
      Figure.tsquare = new THREE.Mesh(Figure.tsquaregeom, tsquaremat);
      Figure.tanplane.add(Figure.tsquare);
    });
  }
  ...
  Figure.renderfunc = function() {
    ...
    if (Figure.boolyplay) {
      Figure.tx += 0.02;
      Figure.xval = (Figure.xrange*Math.sin(Figure.tx) + Figure.xmin + Figure.xmax) / 2;
      Figure.xval = Math.floor(10*Figure.xval)/10;
      Figure.zval = Figure.zFunction(Figure.xval,Figure.yval);
    }
    if (Figure.boolxplay) {
      Figure.ty += 0.02;
      Figure.yval = (Figure.yrange*Math.sin(Figure.ty) + Figure.ymin + Figure.ymax) / 2;
    ...
    if (options.cbxplane != null) Figure.xplane.position.y = Figure.yval;
    if (options.cbyplane != null) Figure.yplane.position.x = Figure.xval;
