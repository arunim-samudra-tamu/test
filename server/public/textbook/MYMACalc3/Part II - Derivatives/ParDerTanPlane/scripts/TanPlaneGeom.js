...
$(document).ready( function() {
  ...
  var xyrenderer_1 = new THREE.WebGLRenderer({canvas: document.getElementById('xyslider_1'), antialias: true});
    xyrenderer_1.setClearColor(0xf0f0f0);
    xyrenderer_1.setPixelRatio(window.devicePixelRatio);
    xyrenderer_1.setSize(300,300);

  var xycamera_1 = new THREE.PerspectiveCamera(35, 1, 0.1, 3000);

  var figure_1 = createTanPlane({
      renderer:renderer_1,
      xyrenderer:xyrenderer_1,
      camera:camera_1,
      xycamera:xycamera_1,
  ...
  var xyrenderer_2 = new THREE.WebGLRenderer({canvas: document.getElementById('xyslider_2'), antialias: true});
    xyrenderer_2.setClearColor(0xf0f0f0);
    xyrenderer_2.setPixelRatio(window.devicePixelRatio);
    xyrenderer_2.setSize(300,300);

  var xycamera_2 = new THREE.PerspectiveCamera(35, 1, 0.1, 3000);

  var figure_2 = createTanPlane({
      renderer:renderer_2,
      xyrenderer:xyrenderer_2,
      camera:camera_2,
      xycamera:xycamera_2,
  ...
  console.log(camera_1.rotation.z + ", " + camera_2.rotation.z);
